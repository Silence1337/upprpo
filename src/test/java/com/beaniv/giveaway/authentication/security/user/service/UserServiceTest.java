...
import com.beaniv.giveaway.repository.RoleRepository;
...
public class UserServiceTest {
    ...
    public void testRegister() {
        ...
        Role role = new Role();
        role.setName("UNCONFIRMED");

        Mockito.when(roleRepository.findByName("UNCONFIRMED")).thenReturn(role);
